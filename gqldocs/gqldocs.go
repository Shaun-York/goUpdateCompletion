...
import "goUpdateCompletion/completion"
...
//UpdatedCompletionByPk UpdatedCompletionByPk
type UpdatedCompletionByPk struct {
	 Compl completion.Completion `json:"update_Completions_by_pk"`
}
//DeleteTaskByPk DeleteTaskByPk
type DeleteTaskByPk struct {
	 Task `json:"delete_Tasks_by_pk"`
}
// Machine machine
type Machine struct {
